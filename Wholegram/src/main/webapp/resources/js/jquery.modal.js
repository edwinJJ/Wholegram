...
function modal(e) {
	...
	e.cModal = function(t) {
		var n = {
				...
				template: '<div class="modal-box"><div class="modal-inner"><div class="modal-title"><a class="modal-close-btn"></a></div><div class="modal-text" style="text-align: center;"></div><div class="modal-buttons"></div></div></div>',
				_classes: {
					box: ".modal-box",
